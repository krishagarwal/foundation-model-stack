...
def matmul_kernel(
    ...
    accumulator = tl.zeros((BLOCK_SIZE_M, BLOCK_SIZE_N), dtype=tl.float32) # TODO: was fp32
    ...
    # c = accumulator.to(tl.int32) # tl.float16)
    c = accumulator.to(tl.float16) # keep in int32
