...
@triton.autotune(
   configs=[
    ...
    # triton.Config({'BLOCK_M': 16, 'BLOCK_N': 256, 'PRE_LOAD_V': True}, num_stages=1 , num_warps=32),
    # triton.Config({'BLOCK_M': 16, 'BLOCK_N': 128, 'PRE_LOAD_V': True}, num_stages=2 , num_warps=32),
    # triton.Config({'BLOCK_M': 16, 'BLOCK_N':  64, 'PRE_LOAD_V': True}, num_stages=4 , num_warps=32),
    # # triton.Config({'BLOCK_M': 16, 'BLOCK_N':  32, 'PRE_LOAD_V': False}, num_stages=16, num_warps=8),
    # # triton.Config({'BLOCK_M': 16, 'BLOCK_N':  16, 'PRE_LOAD_V': False}, num_stages=32, num_warps=8),

    # # triton.Config({'BLOCK_M': 16, 'BLOCK_N': 512, 'PRE_LOAD_V': False}, num_stages=1 , num_warps=4),
    # triton.Config({'BLOCK_M': 16, 'BLOCK_N': 128, 'PRE_LOAD_V': True}, num_stages=1 , num_warps=16),
    # triton.Config({'BLOCK_M': 16, 'BLOCK_N':  64, 'PRE_LOAD_V': True}, num_stages=2 , num_warps=16),
    ...
    # triton.Config({'BLOCK_M': 16, 'BLOCK_N':  64, 'PRE_LOAD_V': True}, num_stages=1 , num_warps=8),
    # triton.Config({'BLOCK_M': 16, 'BLOCK_N':  32, 'PRE_LOAD_V': True}, num_stages=2 , num_warps=8),
    triton.Config({'BLOCK_M': 16, 'BLOCK_N': 256, 'PRE_LOAD_V': False}, num_stages=1 , num_warps=16),
   ],
